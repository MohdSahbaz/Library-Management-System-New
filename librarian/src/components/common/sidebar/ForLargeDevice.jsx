...
const ForLargeDevice = () => {
  ...
  return (
    <div className="hidden scrollbar-hide sticky top-0 overflow-y-auto md:flex flex-col border-r border-gray-700 bg-gradient-to-b from-black via-gray-900 to-gray-800 text-gray-300 p-5 h-screen w-52 shadow-xl">
